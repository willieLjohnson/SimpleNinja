...
public class MainMenu extends GameState {
    ...
    public MainMenu(SimpleNinja game) {
        ...
        mainMenuMusic = Gdx.audio.newMusic(Gdx.files.internal("music/waterfallMusic.mp3"));

        TextureRegion[] menuTexReg = TextureRegion.split(game.getAssetManager().get("menu/waterfallBackground.Png"), 500, 475)[0];
