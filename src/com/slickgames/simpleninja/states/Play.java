...
public class Play extends GameState {
    ...
    public Play(SimpleNinja game) {
        ...
        runningDust.load(Gdx.files.internal("res/particles/runningDust"), Gdx.files.internal("res/particles"));
        runningDust.start();
        ...
        // sfx
        hita = getGame().getAssetManager().get("res/sfx/hit/hit3.wav");
        step = getGame().getAssetManager().get("res/sfx/simpleStep1.wav");
