...
import com.slickgames.simpleninja.handlers.postprocessing.effects.Curvature;
import com.slickgames.simpleninja.handlers.postprocessing.effects.MotionBlur;
import com.slickgames.simpleninja.handlers.postprocessing.effects.Vignette;
...
public class Play extends GameState {
    ...
    //sfx
    Sound hita = game.getAssetManager().get("res/sfx/hit/hit3.wav");
...
private void createProjectile() {
            ...
            bdef.type = BodyType.DynamicBody;
            Trishape.setAsBox(8 / PPM, 10 / PPM, new Vector2(0, -9 / PPM), 0);
//            bdef.linearVelocity.set(1f, 0);
        Body body = world.createBody(bdef);
